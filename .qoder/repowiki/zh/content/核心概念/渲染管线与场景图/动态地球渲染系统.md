...
## 更新摘要
**所做更改**
- 用 protected_ancestors 函数替换了 has_pending_visible_child 方法，提供更全面的祖先链保护机制
- 改进了无数据瓦片的纹理继承逻辑，增强了渲染连续性
- 优化了内存驱逐策略，实现了更智能的GPU资源管理
- 新增了 protected_ancestors 和 has_live_ancestor 辅助函数，提升了快速缩放操作时的渲染质量
- 增强了GPU纹理跟踪和自动分辨率升级功能
...
### 增强的祖先链保护机制
**新增** 实现了更全面的祖先链保护机制，替代了原有的 has_pending_visible_child 方法。
