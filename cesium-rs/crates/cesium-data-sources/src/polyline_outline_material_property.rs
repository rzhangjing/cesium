...
/// Port of the CesiumJS `Property` facet of `PolylineOutlineMaterialProperty`.
impl Property for PolylineOutlineMaterialProperty {
    fn get_value(&self, _time: f64) -> PropertyResult {
        ...
        PropertyResult::String("PolylineOutline".to_string())
    }
    ...
    fn equals(&self, other: &dyn Property) -> bool {
        other
            .as_any()
            .and_then(|any| any.downcast_ref::<PolylineOutlineMaterialProperty>())
            .is_some()
    }
