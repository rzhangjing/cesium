...
/// Port of the CesiumJS `Property` facet of `PolylineDashMaterialProperty`.
impl Property for PolylineDashMaterialProperty {
    fn get_value(&self, _time: f64) -> PropertyResult {
        ...
        PropertyResult::String("PolylineDash".to_string())
    }
    ...
    fn equals(&self, other: &dyn Property) -> bool {
        other
            .as_any()
            .and_then(|any| any.downcast_ref::<PolylineDashMaterialProperty>())
            .is_some()
    }
