...
//!
//! Track B3-1 (terrain picking):
//! - `packages/engine/Specs/Core/TerrainEncodingSpec.js` -> `core_fidelity/terrain_pick_fidelity_spec.rs`
//! - `packages/engine/Specs/Core/TerrainPickerSpec.js`   -> `core_fidelity/terrain_pick_fidelity_spec.rs`
//! - `packages/engine/Specs/Core/TerrainMeshSpec.js`     -> `core_fidelity/terrain_pick_fidelity_spec.rs`
//! - `packages/engine/Specs/Core/BoundingSphereSpec.js` (fromOrientedBoundingBox)
//!   -> `core_fidelity/terrain_pick_fidelity_spec.rs`
//!
//! Track B3-2a0 (Vincenty geodesic):
//! - `packages/engine/Specs/Core/EllipsoidGeodesicSpec.js`
//!   -> `core_fidelity/ellipsoid_geodesic_fidelity_spec.rs`
//!   (goldens regenerated by `core_fidelity/golden_ellipsoid_geodesic.mjs`)
...
#[path = "core_fidelity/terrain_pick_fidelity_spec.rs"]
mod terrain_pick_fidelity_spec;
#[path = "core_fidelity/ellipsoid_geodesic_fidelity_spec.rs"]
mod ellipsoid_geodesic_fidelity_spec;
